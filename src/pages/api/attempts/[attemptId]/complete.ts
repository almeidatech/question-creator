/**
 * PUT /api/attempts/{attemptId}/complete - Complete an exam attempt
 */

import type { NextApiRequest, NextApiResponse } from 'next';
import { getSupabaseClient } from '@/services/database/supabase-client';
import { completeExamAttempt } from '@/services/exams';
import { CompleteAttemptResponse } from '@/schemas/exam-attempt.schema';
