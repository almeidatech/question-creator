/**
 * POST /api/exams/{attemptId}/answers - Submit an answer to a question
 */

import type { NextApiRequest, NextApiResponse } from 'next';
import { getSupabaseClient } from '@/src/services/database/supabase-client';
import { submitAnswer } from '@/src/services/exams';
import { SubmitAnswerSchema, SubmitAnswerResponse } from '@/src/schemas/exam-attempt.schema';
