/**
 * GET /api/exams/{attemptId} - Get attempt details with answers and review
 */

import type { NextApiRequest, NextApiResponse } from 'next';
import { getSupabaseClient } from '@/src/services/database/supabase-client';
import { getAttemptDetails } from '@/src/services/exams';
import { GetAttemptResponse } from '@/src/schemas/exam-attempt.schema';
